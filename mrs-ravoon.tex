...
\newglossaryentry{am}{name={AM}, description={Jane Marczewski}}
...
\newcommand{\stanza}[1]{{\footnotesize\hskip-\vleftskip\llap{\Roman{thestanza} (\gls{#1})}}\hskip\vleftskip\stepcounter{thestanza}\setcounter{thestanzaversion}{1}\ignorespaces}
\newcommand{\stanzaversion}[1]{{\footnotesize\hskip-\vleftskip\llap{\Roman{thestanza}\alph{thestanzaversion} (\gls{#1})}}\hskip\vleftskip\stepcounter{thestanzaversion}\ignorespaces}
...
Were shaken with fear that bordered on panic, \\*
...
for the Yellowhead route is a slow but scerene \\*
